...
const QuizScreen = () => {
    const { currentQuestion, quizProgress, answerSymbols, handleAnswer, isAnimating, showResult, selectedDifficulty, isTimerPaused } = useContext(MathGameContext);
    ...
    // Fix: Corrected the maxQuestions count for black-7 belt
